...
\begin{figure}[hbtp]
	...
	\begin{tikzpicture}  
		\begin{axis}  
			...
			\addplot coordinates {(Apple M1 Firestorm, 5) (Mongoose M2, 5) (Cortex A72, 2.627) (Cortex A53, 2.853)};
			\addplot coordinates {(Apple M1 Firestorm, 5) (Mongoose M2, 5) (Cortex A72, 5.578) (Cortex A53, 4.011)};
			\legend{stock, patch}  
		\end{axis}  
	\end{tikzpicture}\\
	\caption{nbench int}
...
\begin{figure}[hbtp]
	...
	\begin{tikzpicture}  
		\begin{axis}  
			...
			\addplot coordinates {(Apple M1 Firestorm, 12) (Mongoose M2, 12) (Cortex A72, 7.593) (Cortex A53, 5.914)};
			\addplot coordinates {(Apple M1 Firestorm, 12) (Mongoose M2, 12) (Cortex A72, 11.948) (Cortex A53, 6.970)};
			\legend{stock, patch}  
		\end{axis}  
	\end{tikzpicture}\\
