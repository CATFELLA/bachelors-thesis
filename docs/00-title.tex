\begin{titlepage}
	...
	\begin{table}[h!]
		...
		\begin{signstabular}[0.7]{p{7.25cm} >{\centering\arraybackslash}p{4cm} >{\centering\arraybackslash}p{4cm}}
			Студент группы \textbf{<ИУ7-83Б>} & \uline{\mbox{\hspace*{4cm}}} & \uline{\hfill \textbf{<М. Ю. Нитенко>} \hfill} \\
		...
		\begin{signstabular}[0.7]{p{7.25cm} >{\centering\arraybackslash}p{4cm} >{\centering\arraybackslash}p{4cm}}
			Нормоконтролер & \uline{\mbox{\hspace*{4cm}}} & \uline{\hfill \textbf{<Это кто>} \hfill} \\
			& \scriptsize (Подпись, дата) & \scriptsize (И.О. Фамилия)
		\end{signstabular}
	\end{table}
